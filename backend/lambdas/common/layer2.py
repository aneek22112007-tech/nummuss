...
def evaluate_behavioral_guardrails(
    ...
    """
    Layer 2: Behavioral Guardrails (PRD v5.0 Section 07)
    Applies deterministic trading-discipline rules before execution.
    Each block receives a named failure mode.
